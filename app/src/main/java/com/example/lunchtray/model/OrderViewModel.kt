...
class OrderViewModel : ViewModel() {
    ...
    fun resetOrder() {
        ...
        // reset Entree for the order
        _entree.value = null


        //  reset Side for the order
         _side.value = null

        //reset Accompaniment for the order.
        _accompaniment.value = null

        // reset Subtotal for the order
        _subtotal.value = 0.0

        // reset total cost of the order
         _total.value = 0.0


        // reset tax for the order
        _tax.value =0.0
